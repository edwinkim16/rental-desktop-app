...
Public Class frmCheckin
    ...
    Private Sub bttnCheckIn_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bttnCheckIn.Click
        ...
        Else
            If Val(Val(txtSubTotal.Text) * 0.5) > Val(txtAdvance.Text) Then
                MsgBox("top up existing amount amount")
                Exit Sub
            End If
            ...
            If a = vbYes Then
                ...
                If Val(txtSubTotal.Text) < Val(txtAdvance.Text) Or Val(txtSubTotal.Text) = Val(txtAdvance.Text) Then
                    MsgBox("Customer Successfully Checkin! " & "Change: Half " & Val(Val(txtAdvance.Text) - Val(txtSubTotal.Text)).ToString("00.00"), vbInformation, "Check In")
                    ...
                    End If
                Else
                    MsgBox("Customer Successfully Checkin!", vbInformation, "Check In")
                End If
    ...
    Private Sub cboDiscount_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboDiscount.TextChanged
        ...
        lblAdvancePayment.Text = "Advance payment must be atleast half " & (Val(txtSubTotal.Text) * 0.5).ToString("00.00")
        rs.Dispose()
        con.Close()
    End Sub
    ...
    Private Sub lvlcheckin_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lvlcheckin.SelectedIndexChanged
